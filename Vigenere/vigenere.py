# Vigenere Cipher
# A more advanced Ceasar Cipher, where the key consists of multiple shifts.
# The key is often a word, where each letter of the word is a subkey.
# A = 0, Z = 25, and everything in between.
